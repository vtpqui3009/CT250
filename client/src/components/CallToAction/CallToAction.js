const CallToAction = () => {
  return (
    <div className="w-full flex items-center h-60 mt-[65vh] sm:mt-20 relative before:absolute before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)]">
